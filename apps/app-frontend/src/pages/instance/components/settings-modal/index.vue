...
import BedrockInstallationSettings from '@/components/ui/instance_settings/BedrockInstallationSettings.vue'
...
const tabs = computed<TabbedModalTab[]>(() => [
	...
	},
	{
		...
		icon: WrenchIcon,
		content: props.instance.loader?.toLowerCase() === 'bedrock' ? BedrockInstallationSettings : InstallationSettings,
	},
	{
		name: defineMessage({
