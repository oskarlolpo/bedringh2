...
const bedrockCategoriesMap = computed<Record<string, any[]>>(() => ({
	addon: [
		...
		{ id: '4986', name: formatMessage(messages.catMaps), icon: getCategoryIcon('map-pinned'), project_type: 'addon' },
		...
		{ id: '4989', name: formatMessage(messages.catSkins), icon: getCategoryIcon('palette'), project_type: 'addon' },
		...
		{ id: '4987', name: formatMessage(messages.catTextures), icon: getCategoryIcon('palette'), project_type: 'addon' },
